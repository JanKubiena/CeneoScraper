...
Dla {pros_count} opinii pobrano liste zalet, 
a dla {cons_count} opinii pobrano liste wad, 
średnia ocen produktu wynosi: {stars_avg}""")

#hisogram częstości poszczzególnych ocen
...
#udział rekomendacji w ogólnej liczbie opini
